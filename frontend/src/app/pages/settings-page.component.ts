...
@Component({
  ...
  styles: [`
    ...
    .settings-grid { display: grid; grid-template-columns: minmax(260px, 0.8fr) minmax(360px, 1.4fr); gap: 12px; align-items: start; }
    .panel {
      padding: 14px;
      background: #fff;
    ...
    .form-grid { display: grid; grid-template-columns: minmax(0, 1fr) 1fr; gap: 10px; }
